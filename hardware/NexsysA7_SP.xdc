...
set_property EXCLUDE_FROM_ANALYSIS TRUE [get_ports clk_in1]
...
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { LED0 }]; #IO_L18N_T2_A11_D27_14 Sch=led[5]

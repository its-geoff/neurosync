module coord_gen #(
    ...
    logic signed [63:0] coord_re64, coord_im64;
    ...
    always_comb begin
        ...
        if (zoom_q28 != 0) begin
            coord_re64 = (dx_q28_64 <<< 28) / $signed(zoom_q28); // still Q4.28
            coord_im64 = (dy_q28_64 <<< 28) / $signed(zoom_q28);
        end else begin
            coord_re64 = 64'sd0;
            coord_im64 = 64'sd0;
        end

        c_re_next = cx_q28 + coord_re64[31:0];
        c_im_next = cy_q28 + coord_im64[31:0];
    end
